# Explanation of solution: This follows the merge sort algorithm with some modification. The formula is as following. Start with the array. Break it into left
...
# Complexities Explanation: The space comes from the mergeInversions helper method since it combine a left and right array, so we need at most O(n). For the space
