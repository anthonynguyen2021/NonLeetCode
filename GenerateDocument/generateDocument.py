# Idea (motivation) of solution: We want to count how many of character 'a' is in characters (for instance) and how many of 'a' is in document without having to pass through 
