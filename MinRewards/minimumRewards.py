# Idea of solutions #1-3: At index i, if scores[i-1] < scores[i], you want rewards[i+1] = rewards[i] + 1 - draw a couple of examples. Suppose at index i, you have 
...
# Idea of Solution 1: Note that a local min has reward 1 to be optimal. Initialize rewards = [1 for _ in scores] Go from index 1 to the end. If scores[i] > scores[i-1], 
