# Explanation / Logic of solution: It's enough to have separate arrays for start time and end time to solve this problem. Sort these two arrays. We have two pointers startIdx and
...
# Explanation of complexities: The space follows from storing start & end arrays. The time follows from sorting start and end. The while loop is an O(n) time operation.
