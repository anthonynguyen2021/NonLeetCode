...
def kadanesAlgorithm(array):
	...
	Observe that any contiguous non-empty subarray that sums to a number less than 0, we can disregard. This is an example of a greedy algorithm. 
	...
	for idx in range(len(array)):
		...
		if currentSum < 0:  # reset sum to 0
			currentSum = 0
