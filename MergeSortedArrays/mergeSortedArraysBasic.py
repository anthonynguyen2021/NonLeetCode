...
def mergeSortedArrays(arrays):
	...
	We grab an element from each of the k arrays - this element is the array ID.
	...
	k for each step in the do while where we do this for n times - the total elements.
