# Explanation: Go through the characters in the string from left to right, if we see the character
...
# Explanation of complexities: Time follows from iterating through the string. The space comes from the
