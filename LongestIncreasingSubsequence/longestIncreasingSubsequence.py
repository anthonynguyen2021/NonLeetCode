...
def longestIncreasingSubsequence(array):
	...
	We use bottom up DP to build our solution. The longestSubsequence array is the solution we build where index i is the largest length of subsequence of array[:i+1]
	...
	Time comes from the two for loop, and space comes from longestSubsequennce & previousIdx array. Note that buildSequence method is O(n) time and space. 
	'''
