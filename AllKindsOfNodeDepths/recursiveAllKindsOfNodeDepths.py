# Idea of solution: We write a recursive method that sums the depth of a rooted tree. We write another recursive method that in a sense does post-order traversal where
