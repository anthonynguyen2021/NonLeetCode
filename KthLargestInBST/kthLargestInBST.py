...
def findKthLargestValueInBst(tree, k):
	...
	When we traverse a BST in the in-order traversal way, the resulting visited nodes are sorted.
	We store the list of visited values and look at the len(array) - k index for the kth largest. 
