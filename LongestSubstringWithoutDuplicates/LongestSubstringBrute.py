...
# Solution Idea: At each index of the string, we keep marching until we seee a duplicate. We keep track of the length of this substring and store how to get this substring somewhere.
