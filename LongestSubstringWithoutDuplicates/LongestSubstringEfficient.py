...
# substring you're considering.
# Next, we check the length of the current substring in question and update longest substring; we 
# update the index of the last time we've seen chara, which is i; the order of these two don't matter
