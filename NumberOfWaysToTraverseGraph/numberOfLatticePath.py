# Idea of solution: Imagine we have a lattice of size height-1 by width-1. The number of ways to go from top left to bottom right using only down and right moves is the 
